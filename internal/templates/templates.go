...
var AllMarkers = []string{MarkerGoal, MarkerState, MarkerGraph, MarkerBrief, MarkerMetrics}
...
// agent that treats a positional string as flags.
func Load(role string) (string, error) {
	name := "templates/" + role + ".md"
